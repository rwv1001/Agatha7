module ModelDependencyHelper
  def get_affected_relationships_for_update(table_name, object_id, field_name)
    ...
    return consolidated_relationships.values
  end

  def send_data_invalidation_for_update(table_name, object, field_name, object_id)
    begin
      ...
      Rails.logger.error "ActionCable broadcast failed in send_data_invalidation_for_update: #{e.message}"
