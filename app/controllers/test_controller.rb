class TestController < ApplicationController
  ...
  def search_init
    ...
    logger.debug "Creating #{table_options.length} search controllers..."
    ...
    logger.debug "Created #{@search_ctls.keys.length} search controllers"
    ...
    if person_controller && person_controller.filter_controller
      begin
        ...
        logger.debug "GetOptions test successful: returned #{options.length} options"
        ...
        if course_controller
          ...
          logger.debug "SuggestedLecture test successful: #{suggested_lecture.class}"

          # Test SuggestedTutorial functionality
          suggested_tutorial = SuggestedTutorial.default(course_controller)
          logger.debug "SuggestedTutorial test successful: #{suggested_tutorial.class}"
